...
namespace FinaroEngine.Tests
{
    public class ContractCallTests
    {
        ...
        {
            this.url = "https://ropsten.infura.io/a19089f9d4c54f518fca6588f04b43d2";
            this.contractAddress = "0x08564660169a2559492EF1315FD2FBd17Bf84d54";
        ...
        [Fact]
        public async Task SendUserSingleToken()
        {
            string privateKey = "466aa69475dd2bed841db861f9bf36d94ba3f8852195317e54718efda22978e8";
            ContractCall contractCall = new ContractCall(url, contractAddress, abi);
            var result = await contractCall.SendTokensAsync(privateKey, RopstenAccount.Mark, 1.23);            
        }
    }
